...
const ShippingInfoSection: React.FC<{
  formData: CheckoutFormData;
  handleInputChange: (
    e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>,
  ) => void;
    ...
    <div className="grid gap-4 md:grid-cols-2">
      ...
      {formData.paymentMethod === 'cashOnDelivery' && (
        <div className="flex md:col-span-2 md:w-full">
          <div className="w-1/4">
            <img src={DeliveryIcon} alt="cash on delivery" className="p-4" />
          </div>
    ...
    <div>
      ...
      <div className="pt-6 mt-6 space-y-2 text-lg">
        ...
        <div className="flex justify-between">
          ...
          <p className="font-bold text-secondary-black">${formatPrice(vat)}</p>
        </div>
        <div className="flex justify-between pt-4 mt-4">
          <p className="text-xl font-semibold text-primary">Grand Total</p>
